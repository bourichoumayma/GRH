      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var E = String(m[0]), O = a(s(u(m.index), p.length), 0), P = [], F = 1; F < m.length; F++) P.push(void 0 === (S = m[F]) ? S : String(S));
            var M = m.groups;
            if (h) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < p.length; ) {
              ...
              var _,
                E = f(b, v ? p : p.slice(x));
              if (null === E || (_ = l(c(b.lastIndex + (v ? 0 : x)), p.length)) === S) x = u(p, x, d);
              else {
