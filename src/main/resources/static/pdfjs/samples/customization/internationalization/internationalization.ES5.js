!(function(t) {
  ...
  function(t, n) {
    WebViewer(
      {
        path: '../../../lib',
        additionalTranslations: { language: 'en', translations: { 'option.toolbarGroup.toolbarGroup-View': 'Edited View Label' } },
      ...
      samplesSetup(t),
        ...
        t.UI.settingsMenuOverlay.add({ type: 'actionButton', className: 'row', dataElement: 'languageButton', label: 'Language' }, 'downloadButton');
    });
  },
]);
