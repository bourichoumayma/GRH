!(function(t) {
  ...
  function(t, n) {
    ...
    WebViewer({ path: '../../../lib', initialDoc: '../../files/table.pdf' }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      (t.next = 2),
                      fetch('https://ai-serve.pdftron.com/extract/predict', { method: 'POST', body: n, headers: { 'File-Name': n.name || 'test_pdf.pdf', 'Content-Type': 'application/json' } })
                    );
                  case 2:
                    return (r = t.sent), (t.next = 5), r.json();
                  case 5:
                    return (e = t.sent), (o = e.xfdf), (i = e.html), t.abrupt('return', { xfdf: o, html: i });
                  case 8:
                  case 'end':
                    return t.stop();
                }
          ...
          regeneratorRuntime.mark(function t() {
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (e = r.getDocument()), (t.next = 3), e.getFileData();
                  case 3:
                    return (i = t.sent), (u = e.getFilename()), (c = new Uint8Array(i)), (f = new File([c], u, { type: 'application/pdf' })), (t.next = 9), o(f);
                  case 9:
                    (a = t.sent), (s = a.xfdf), n.importAnnotations(s);
                  case 12:
                  case 'end':
                    return t.stop();
                }
            ...
            regeneratorRuntime.mark(function t(n) {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      (e = n.target.files[0]) && r.loadDocument(e);
                    case 2:
                    case 'end':
                      return t.stop();
                  }
